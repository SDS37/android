...
public class UserLoginActivity extends MainActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Toast.makeText(getApplicationContext(), "User area", Toast.LENGTH_SHORT).show();
		
		usernameSubmitted = (EditText) findViewById(R.id.user_username);
		passwordSubmitted = (EditText) findViewById(R.id.user_password);

		LoginFormView = findViewById(R.id.login_form);
		LoginStatusView = findViewById(R.id.login_status);
		LoginStatusMessageView = (TextView) findViewById(R.id.login_status_message);

		findViewById(R.id.user_submit_button).setOnClickListener(
	...
	public class LoginTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			...
			HttpPost post = new HttpPost("http://" + ip + ":9000/user-login");
